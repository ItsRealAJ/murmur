...
const MATRIX = [
  ...
  [
    "lan gpt-oss cleanup: family low floor in both the pin and the reasoning object, no contradictory none",
    "lan",
    "gpt-oss-20b-mxfp4",
    null,
    CLEANUP_NO_THINK,
  ...
  [
    "lan gpt-oss suppression sends the family floor, never the off value the family lacks",
    "lan",
    "gpt-oss-20b-mxfp4",
    null,
    AGENT_NO_THINK,
