      ...
      <div ref={containerRef} className="relative">
        {isEditing ? (
          <div className="relative">
            ...
            <div className="absolute right-1 top-1/2 -translate-y-1/2 flex items-center gap-0.5">
              <button
                type="button"
                onClick={save}
                className="h-6 w-6 flex items-center justify-center rounded text-success hover:bg-success/10 active:scale-95 transition-[background-color,border-color,color,opacity]"
              ...
              <button
                type="button"
                onClick={cancel}
                className="h-6 w-6 flex items-center justify-center rounded text-muted-foreground/50 hover:text-muted-foreground hover:bg-muted/50 active:scale-95 transition-[background-color,border-color,color,opacity]"
          ...
          <button
            type="button"
            onClick={enterEdit}
            className={`w-full h-8 flex items-center px-3 rounded border text-sm transition-[background-color,border-color,color,opacity] cursor-pointer group ${
              hasKey
